...
##-----------------------------------------
## Exd Fig. 5: Significant interaction by superclass  
##-----------------------------------------

##----------------------------------
## 5a and 5c: TICS and AMED by APOE4 and PRS
##----------------------------------
...
amed_tics <- fread("results/supp/amed_tics_by_gene.txt") %>%
...
pdf("results/extended/extended_fig5a.pdf", width = 10, height = 2)  
...
pdf("results/extended/extended_fig5c_1.pdf", width = 10, height = 2)  
grid.arrange(grobs = plot_list, ncol = 3, padding = unit(c(4,4), "cm")) 
dev.off()
...
pdf("results/extended/extended_fig5c_2.pdf", width = 10, height = 2)  
grid.arrange(grobs = plot_list, ncol = 3, padding = unit(c(4,4), "cm")) 
dev.off()

##----------------------------------
## 5b: dementia and AMED by PRS
##----------------------------------
...
pdf("results/extended/extended_fig5b.pdf", width = 6, height = 2, onefile = F)
