...
pdf("results/figures/fig3a_amed_dementia_spline.pdf", width = 2, height = 3, onefile = F)
...
pdf("results/figures/fig3a_amed_tics_linear.pdf", width = 1.5, height = 3, onefile = F)
...
pdf("results/figures/fig3a_amed_both.pdf", width = 5, height = 3, onefile = F)
