...
tmp_genetic <- merged_data %>% mutate(APOE4 = relevel(APOE4, ref = "0"))
...
pdf("results/figures/fig1d_cumu_incid_APOE4_unadjusted_all_nhs.pdf", width = 5, height = 4, onefile = F)
...
tmp_genetic <- merged_data %>% mutate(PGS002280_t = relevel(PGS002280_t, ref = "1"))
...
text1 <- paste0(round(coxmod_ci1[1],2)," (",round(coxmod_ci1[3],2),", ",round(coxmod_ci1[4],2),")")
text2 <- paste0(round(coxmod_ci2[1],2)," (",round(coxmod_ci2[3],2),", ",round(coxmod_ci2[4],2),")")
pdf("results/figures/fig1d_cumu_incid_PGS002280_t_unadjusted_all_nhs.pdf", width = 5, height = 4, onefile = F)
...
pdf("results/figures/fig1d_km_plot.pdf", width = 6, height = 9, onefile = F)
