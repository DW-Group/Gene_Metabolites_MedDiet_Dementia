...
data int_hpfs; set int_hpfs; cohorts='hpfs'; factors='main_interaction';run;

PROC EXPORT DATA= int_hpfs
            OUTFILE="/results/amed_APOE4_interaction_hpfsfull_baseline.csv"
            DBMS=csv REPLACE;
RUN;
