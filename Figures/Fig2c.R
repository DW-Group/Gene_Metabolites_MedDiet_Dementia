...
load("results/met_dem_cox_baseline_nhs_2023_filtered_res4.RData")
...
# write.table(strata_ind_var_res_dat, "results/met_dem_cox_baseline_stratified_individual_variants_nhs_2023.txt", row.names=F, quote=F, sep="\t")

strata_ind_var_res_dat <- fread("results/met_dem_cox_baseline_stratified_individual_variants_nhs_2023.txt")
...
pdf("results/figures/fig2c_call_out.pdf", width = 8, height = 4.5, onefile = F)
