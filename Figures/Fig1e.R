...
pdf("results/figures/fig1e_diet_median_distribution.pdf", width = 7, height = 4.5, onefile = F)
diet_median_plot
dev.off()
...
pdf("results/figures/fig1e_diet_histogram.pdf", width = 7, height = 5, onefile = F)
diet_hist_plot
dev.off()
