...
pdf("results/figures/fig2a_strat_legend_10102024.pdf", width = 5, height = 3, onefile = F)
...
tmp3 <- tmp_inter_ind_var %>%
  ...
  mutate(gene_group_anno = "Other~AD~variants")
...
pdf("results/figures/fig2a_inter_legend_10102024.pdf", width = 5, height = 3, onefile = F)
...
pdf("results/figures/fig2a_sig_findings_10172024.pdf", width = 14, height = 21, onefile = F)
