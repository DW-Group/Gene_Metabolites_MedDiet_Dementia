...
load("data/metabolites/rf_imputated_metabolites_nhs.RData")
...
#                 metric = "Accuracy",
#                 trControl = trControl)
# save(rf_bin_res, file = "results/diet_met_rf_model_binary.RData")

load("results/diet_met_rf_model_binary.RData")
...
pdf("results/figures/fig3c_auc_rf.pdf", width = 4.5, height = 5, onefile = F)
p_roc
dev.off()
