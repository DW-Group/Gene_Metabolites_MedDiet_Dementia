...
coloc_hits <- read_excel("results/coloc_res.xlsx") %>%
  filter(PP4_div_PP3_plus_PP4>=0.7|PP.H4.abf>=0.7)
exposure_dict <- read_excel("results/instruments_selected_sig_final_anno.xlsx") %>%
...
mr_res <- read_excel("results/mr_results_final.xlsx") %>%
