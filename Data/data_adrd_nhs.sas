...
%include "scripts/food_nhs.sas"; 
    ...
    %amed8020(keep=amed_80 amed_84 amed_86 amed_90 amed_94 amed_98 amed_02 amed_06 amed_10 amed_20);
      run;
  ...
  /*passthru or missing is 998 or 999*/
   ...
   %der7620 (keep=irt76 irt78 irt80 irt82 irt84 irt86 irt88 irt90 irt92 irt94 irt96 irt98
		irt00 irt02 irt04 irt06 irt08 irt10 irt12 irt14 irt16 irt20/*date of questionnaire return*/
		yobf mobf /*year of birth and month of birth*/
		bmiage18 bmi76 bmi78 bmi80 bmi82 bmi84 bmi86 bmi88 bmi90 bmi92 bmi94 bmi96 bmi98 bmi00
		bmi02 bmi04 bmi06 bmi08 bmi10 bmi12 bmi14 bmi16 bmi20/*bmi*/
		/*age76 age78 age80 age82 age84 age86 age88 age90 age92 age94 age96 age98 age00
		age02 age04 age06 age08 age10 age12 age14 age16 /*age in years at questionnaire return; some are missing so going to calculate with irt and bdt in doloop*/
  ...
  /*read in medication data (only contains aspirin and NSAID use in meds8016*/
    ...
    %nur86(keep=wt86 str86 ra86 cabg86 chol86 hbp86 sysbp86 diabp86 db86 mi86 ang86); 

    %nur88(keep=wt88 physx88 str88 ra88 cabg88 thiaz88 ccblo88 betab88 ace88 bprx88 clrx88 pct588 pct1088
                chol88 hbp88 sysbp88 diabp88 db88 mi88  ang88
                fdb88 sdb88 mdb88 bdb88 dbfh88);
                if fdb88=1 or mdb88=1 or sdb88=1 or bdb88=1 then dbfh88=1; else dbfh88=0; 

    %nur90(keep=wt90 physx90 str90 ra90 cabg90 chol90 hbp90 sysbp90 diabp90 db90 mi90 ang90); run;
    ...
    %nur94(keep=wt94 physx94 str94 cabg94 thiaz94 lasix94 ccblo94 betab94 bprx94 couma94  digox94 clrx94 chol94 hbp94 sysbp94 diabp94 db94 mi94 ang94); run;
    ...
    %nur98(keep=wt98 physc98 physy98 str98 cabg98 thiaz98   lasix98    ccblo98    betab98    ace98   bprx98 couma98   digox98   antia98
                   antid98 chrx98 chrx98 chol98 hbp98 sysbp98 diabp98 db98 mi98 ang98);  
    ...
    %nur04(keep=wt04 physc04 physy04 str04 strd04 ra04 rad04 renf04 renfd04 ang04 angd04
                ...
                marry04 alone04 mev04 zoc04 crest04 prav04 lip04 lesc04 oclrx04 chol04 hbp04 sysbp04 diabp04 db04 mi04
    ...
    %nur08(keep=physc08 physy08 str08 strd08 ra08 rad08 yr08 mo08 wt08
                db08 chol08 hbp08 sysbp08 diabp08 mi08 mid08 ang08 angd08 str08 strd08 alone08 marry08
   ...
   %nur12(keep= wt12 ra12 rad12 chol12 hbp12 sysbp12 diabp12 db12 mi12	mid12	mih12
  ...
  %nur16(keep= wt16 ra16 rad16 chol16 hbp16 db16 mi16	mid16	mih16 marry16 alone16
   ...
   %nur20(keep= alzdem20 alzdemd20 
    ...
    data alladrd;
    merge der7620 (in=der)  foodsnhs ahei2010 ahei80 amed8020
          ...
          meds8016 disease nhs_mets  exernhs supp8016 nses8616 nhspdcase
          memorynhs;
     by id;
     exrec=1;
...
run; 
   ...
   proc datasets;
        delete der7620 foodsnhs ahei2010 ahei80   
               n767880 nur82 nur84 nur86 nur88 nur90 nur92 nur94 nur96 nur98 nur00 nur02 nur04 nur06 nur08 nur10 nur12 nur14 nur16 nur20
               meds8016 disease nhs_mets  exernhs supp8016 nses02 nhspdcase;
   run;
 ...
 data pre_pm;
     ...
     *diseases at baseline 1988;
      if db76=1 or db78=1 or db80=1 or db82=1 or db84=1 or db86=1 or db88=1 then db_7688=1; else db_7688=0;      
      if hbp76=1 or hbp78=1 or hbp80=1 or hbp82=1 or hbp84=1 or hbp86=1 or hbp88=1 then hbp_7688=1; else hbp_7688=0;
      if chol76=1 or chol78=1 or chol80=1 or chol82=1 or chol84=1 or chol86=1 or chol88=1 then chol_7688=1;else chol_7688=0; 
      if  mi76=1 or mi78=1 or mi80=1 or mi82=1 or mi84=1 or mi86=1 or mi88=1 then mi7688=1; else mi7688=0;
      if  can76=1 or can78=1 or can80=1 or can82=1 or can84=1 or can86=1 or can88=1 then can7688=1; else can7688=0; 
      if  str82=1 or str84=1 or str86=1 or str88=1 then str8288=1; else str8288=0; 
      ...
      array irt     {18} irt88     irt90     irt92     irt94     irt96     irt98     irt00     irt02     irt04     irt06     irt08     irt10     irt12     irt14     irt16     irt18     irt20   cutoff;
      array tvar    {17} t88       t90       t92       t94       t96       t98       t00       t02       t04       t06       t08       t10       t12       t14       t16       t18       t20      ;
      array age     {17} age88     age90     age92     age94     age96     age98     age00     age02     age04     age06     age08     age10     age12     age14     age16     age18     age20    ;
      array wt      {17} wt88      wt90      wt92      wt94      wt96      wt98      wt00      wt02      wt04      wt06      wt08      wt10      wt12      wt14      wt16      wt16      wt20     ;
      array bmi     {17} bmi88     bmi90     bmi92     bmi94     bmi96     bmi98     bmi00     bmi02     bmi04     bmi06     bmi08     bmi10     bmi12     bmi14     bmi16     bmi16     bmi20    ; 
      array actm    {17} th88      th90      th92      th94      th96      th98      th00      th02      th04      th06      th08      th10      th12      th14      th14      th14      th14     ;
      array nsmk    {17} smkdr88   smkdr90   smkdr92   smkdr94   smkdr96   smkdr98   smkdr00   smkdr02   smkdr04   smkdr06   smkdr08   smkdr10   smkdr12   smkdr14   smkdr16   smkdr16   smkdr20  ;
      array smm     {17} smm88     smm90     smm92     smm94     smm96     smm98     smm00     smm02     smm04     smm06     smm08     smm10     smm12     smm14     smm16     smm16     smm20    ;
      array hor     {17} nhor88    nhor90    nhor92    nhor94    nhor96    nhor98    nhor00    nhor02    nhor04    nhor06    nhor08    nhor10    nhor12    nhor14    nhor16    nhor16    nhor20   ; 
      array mvyn    {17} mvyn88    mvyn90    mvyn92    mvyn94    mvyn96    mvyn98    mvyn00    mvyn02    mvyn04    mvyn06    mvyn08    mvyn10    mvyn12    mvyn14    mvyn16    mvyn16    mvyn16   ;
      array aspu    {17} aspu88    aspu90    aspu92    aspu94    aspu96    aspu98    aspu00    aspu02    aspu04    aspu06    aspu08    aspu10    aspu12    aspu14    aspu16    aspu16    aspu16   ; 
      array alone   {17} alone80   alone80   alone92   alone92   alone96   alone96   alone00   alone00   alone04   alone04   alone08   alone08   alone12   alone12   alone16   alone16   alone20  ;       
      array mar     {17} mar80     mar80     mar80     mar80     mar96     mar96     mar00     mar00     mar04     mar04     mar08     mar08     mar12     mar12     mar16     mar16     mar20    ;

      array sysbp   {17} sysbp88   sysbp90   sysbp90   sysbp94   sysbp94   sysbp98   sysbp98   sysbp98   sysbp04   sysbp04   sysbp08   sysbp08   sysbp12   sysbp12   sysbp12   sysbp12   sysbp12  ;
      array diabp   {17} diabp88   diabp90   diabp90   diabp94   diabp94   diabp98   diabp98   diabp98   diabp04   diabp04   diabp08   diabp08   diabp12   diabp12   diabp12   diabp12   diabp12  ;

      array diab    {17} db_7688   db90      db92      db94      db96      db98      db00      db02      db04      db06      db08      db10      db12      db14      db16      db16      db20     ;
      array chol    {17} chol_7688 chol90    chol92    chol94    chol96    chol98    chol00    chol02    chol04    chol06    chol08    chol10    chol12    chol14    chol16    chol16    chol20   ;
      array rphbp   {17} hbp_7688  hbp90     hbp92     hbp94     hbp96     hbp98     hbp00     hbp02     hbp04     hbp06     hbp08     hbp10     hbp12     hbp14     hbp16     hbp16     hbp20    ;
      array antid   {17} antidep76 antidep76 antidep76 antidep76 antidep96 antidep98 antidep00 antidep02 antidep04 antidep06 antidep08 antidep10 antidep12 antidep14 antidep16 antidep16 antidep20; 
      array antihp  {17} htnrx88   htnrx88   htnrx88   htnrx94   htnrx96   htnrx98   htnrx00   htnrx02   htnrx04   htnrx06   htnrx08   htnrx10   htnrx12   htnrx14   htnrx16   htnrx16   htnrx20  ; 
      array antitc  {17} hchtx88   hchtx88   hchtx88   hchtx94   hchtx96   hchtx98   hchtx00   hchtx02   hchtx04   hchtx06   hchtx08   hchtx10   hchtx12   hchtx14   hchtx16   hchtx16   hchtx20  ;  
      array repmi   {17} mi7688    mi90      mi92      mi94      mi96      mi98      mi00      mi02      mi04      mi06      mi08      mi10      mi12      mi14      mi16      mi16      mi20     ;
      array repstrk {17} str8288   str90     str92     str94     str96     str98     str00     str02     str04     str06     str08     str10     str12     str14     str16     str16     str20    ;          
      array cance   {17} can7688   can90     can92     can94     can96     can98     can00     can02     can04     can06     can08     can10     can12     can14     can16     can16     can20    ;
      array depr    {17} depr80    depr80    depr80    depr80    depr80    depr80    depr00    depr02    depr04    depr06    depr08    depr10    depr12    depr14    depr16    depr16    depr20   ;
      array hypo    {17} hypo80    hypo80    hypo80    hypo80    hypo80    hypo80    hypo00    hypo02    hypo02    hypo02    hypo02    hypo02    hypo12    hypo12    hypo12    hypo12    hypo12   ;

      array trmeatcon{17} trmeat86d   trmeat90d  trmeat90d   trmeat94d  trmeat94d  trmeat98d  trmeat98d  trmeat02d  trmeat02d  trmeat06d  trmeat06d  trmeat10d  trmeat10d  trmeat10d  trmeat10d  trmeat10d trmeat20d; 
      array prmeatcon{17} prmeat86d   prmeat90d  prmeat90d   prmeat94d  prmeat94d  prmeat98d  prmeat98d  prmeat02d  prmeat02d  prmeat06d  prmeat06d  prmeat10d  prmeat10d  prmeat10d  prmeat10d  prmeat10d prmeat20d; 
      array urmeatcon{17} urmeat86d   urmeat90d  urmeat90d   urmeat94d  urmeat94d  urmeat98d  urmeat98d  urmeat02d  urmeat02d  urmeat06d  urmeat06d  urmeat10d  urmeat10d  urmeat10d  urmeat10d  urmeat10d urmeat20d; 
      array calor    {17} calor86n    calor90n   calor90n    calor94n   calor94n   calor98n   calor98n   calor02n   calor02n   calor06n   calor06n   calor10n   calor10n   calor10n   calor10n   calor10n  calor20n;
      array alco     {17} alco86n     alco90n    alco90n     alco94n    alco94n    alco98n    alco98n    alco02n    alco02n    alco06n    alco06n    alco10n    alco10n    alco10n    alco10n    alco10n   alco20n;

      array fruitscon{17} fruits86d   fruits90d  fruits90d   fruits94d  fruits94d  fruits98d  fruits98d  fruits02d  fruits02d  fruits06d  fruits06d  fruits10d  fruits10d  fruits10d  fruits10d  fruits10d fruits20d; 
      array vegealcon{17} vegeal86d   vegeal90d  vegeal90d   vegeal94d  vegeal94d  vegeal98d  vegeal98d  vegeal02d  vegeal02d  vegeal06d  vegeal06d  vegeal10d  vegeal10d  vegeal10d  vegeal10d  vegeal10d vegeal20d; 
      array whgrnscon{17} whgrns86d   whgrns90d  whgrns90d   whgrns94d  whgrns94d  whgrns98d  whgrns98d  whgrns02d  whgrns02d  whgrns06d  whgrns06d  whgrns10d  whgrns10d  whgrns10d  whgrns10d  whgrns10d whgrns20d; 
      array poultrcon{17} poultr86d   poultr90d  poultr90d   poultr94d  poultr94d  poultr98d  poultr98d  poultr02d  poultr02d  poultr06d  poultr06d  poultr10d  poultr10d  poultr10d  poultr10d  poultr10d poultr20d; 
      array fishalcon{17} fishal86d   fishal90d  fishal90d   fishal94d  fishal94d  fishal98d  fishal98d  fishal02d  fishal02d  fishal06d  fishal06d  fishal10d  fishal10d  fishal10d  fishal10d  fishal10d fishal20; 
      array regeggcon{17} regegg86d   regegg90d  regegg90d   regegg94d  regegg94d  regegg98d  regegg98d  regegg02d  regegg02d  regegg06d  regegg06d  regegg10d  regegg10d  regegg10d  regegg10d  regegg10d regegg20d; 
      array nutsalcon{17} nutsal86d   nutsal90d  nutsal90d   nutsal94d  nutsal94d  nutsal98d  nutsal98d  nutsal02d  nutsal02d  nutsal06d  nutsal06d  nutsal10d  nutsal10d  nutsal10d  nutsal10d  nutsal10d nutsal20d; 
      array nutlegcon{17} nutleg86d   nutleg90d  nutleg90d   nutleg94d  nutleg94d  nutleg98d  nutleg98d  nutleg02d  nutleg02d  nutleg06d  nutleg06d  nutleg10d  nutleg10d  nutleg10d  nutleg10d  nutleg10d nutleg20d; 
      array tdairycon{17} tdairy86d   tdairy90d  tdairy90d   tdairy94d  tdairy94d  tdairy98d  tdairy98d  tdairy02d  tdairy02d  tdairy06d  tdairy06d  tdairy10d  tdairy10d  tdairy10d  tdairy10d  tdairy10d tdairy20d; 
      array ldairycon{17} ldairy86d   ldairy90d  ldairy90d   ldairy94d  ldairy94d  ldairy98d  ldairy98d  ldairy02d  ldairy02d  ldairy06d  ldairy06d  ldairy10d  ldairy10d  ldairy10d  ldairy10d  ldairy10d ldairy20d; 
      array hdairycon{17} hdairy86d   hdairy90d  hdairy90d   hdairy94d  hdairy94d  hdairy98d  hdairy98d  hdairy02d  hdairy02d  hdairy06d  hdairy06d  hdairy10d  hdairy10d  hdairy10d  hdairy10d  hdairy10d hdairy20d; 
      array legumecon{17} legume86d   legume90d  legume90d   legume94d  legume94d  legume98d  legume98d  legume02d  legume02d  legume06d  legume06d  legume10d  legume10d  legume10d  legume10d  legume10d legume20d; 
      array soyprocon{17} soypro86d   soypro90d  soypro90d   soypro94d  soypro94d  soypro98d  soypro98d  soypro02d  soypro02d  soypro06d  soypro06d  soypro10d  soypro10d  soypro10d  soypro10d  soypro10d soypro20d; 
      array dcoffcon {17} dcaf_s86    dcaf_s90   dcaf_s90    dcaf_s94   dcaf_s94   dcaf_s98   dcaf_s98   dcaf_s02   dcaf_s02   dcaf_s06   dcaf_s06   dcaf_s10   dcaf_s10   dcaf_s10   dcaf_s10   dcaf_s10  dcaf_s20 ;
      array coffcon  {17} coff_s86    coff_s90   coff_s90    coff_s94   coff_s94   coff_s98   coff_s98   coff_s02   coff_s02   coff_s06   coff_s06   coff_s10   coff_s10   coff_s10   coff_s10   coff_s10  coff_s20 ;
      array nacon    {17} na86a       na90a      na90a       na94a      na94a      na98a      na98a      na02a      na02a      na06a      na06a      na10a      na10a      na10a      na10a      na10a     na20a    ;


      array ssbcon   {17} ahei2010_ssb86         ahei2010_ssb90        ahei2010_ssb90        ahei2010_ssb94        ahei2010_ssb94        ahei2010_ssb98        ahei2010_ssb98 
      ...
      array aheis    {17} ahei_nomt_86          ahei_nomt_90          ahei_nomt_90          ahei_nomt_94          ahei_nomt_94          ahei_nomt_98
      ...
      array aheia    {17} ahei2010_86           ahei2010_90           ahei2010_90           ahei2010_94           ahei2010_94           ahei2010_98
                          ahei2010_98           ahei2010_02           ahei2010_02            ahei2010_06            ahei2010_06           ahei2010_10           ahei2010_10           ahei2010_10           ahei2010_10           ahei2010_10           ahei2010_10;

      array ameds    {17} amed_86      amed_90     amed_90       amed_94    amed_94      amed_98    amed_98     amed_02     amed_02     amed_06     amed_06     amed_10     amed_10      amed_10    amed_10    amed_10      amed_20; 
      array SES      {17} nSES_88     nSES_90    nSES_92      nSES_94   nSES_96     nSES_98   nSES_00    nSES_02    nSES_04    nSES_06    nSES_08    nSES_10    nSES_12     nSES_14   nSES_16   nSES_16     nSES_16 ;
   ...
   do i=2 to 17;
      ...
      if sysbp{i}=.               then sysbp{i}     = sysbp{i-1};
      if diabp{i}=.               then diabp{i}     = diabp{i-1};
...
/*** alcohol ***/
  ...
  ******covariables******;
   ...
   %exclude(pdcase eq 1);
   %exclude(str8288 eq 1);
   %exclude(can7688 eq 1);
...
keep id period period agecon cutoff confadcase adcase tad dtdx_ad dtdth nfadcase  fadcase 
     t88 t90 t92 t94 t96 t98 t00 t02 t04 t06 t08 t10 t12 t14 t16 t18 t20
     irt88 irt90 irt92 irt94 irt96 irt98 irt00 irt02 irt04 irt06 irt08 irt10 irt12 irt14 irt16 irt18 irt20
     white &hiedu_ &husbedu_ fhdem marry live_alone nSES aspirin mvit &smkk_ &actcc_ &phmsstatus_ &bmic_ ahei
     bmi88 hbp_7688 db_7688 chol_7688 mi7688 can7688 
     htn diabetes hchol hypothyroid depression antidep antihtc antihbp chd stroke cancer 
     smkk  bmic  
     daykcal 
     sysbpcon diabpcon
     bmicon actcon phmsstatus hiedu husbedu &alcc_ alcocon alcc 
     ADdiagage bdt
     dementiadeath alz0220 q02 q04 q06 q08 q10 q12 q14 q16 q20;
run; 
...
data pre_pm;
  ...
  if bmi88<23 then bmi88c=1;
           else if 23=<bmi88<25 then bmi88c=2;
             else if 25=<bmi88<30 then bmi88c=3;
               else if 30=<bmi88<35 then bmi88c=4;
                 else bmi88c=5;
          if bmi88=. then bmi88c=.;
         %indic3(vbl=bmi88c, prefix=bmi88c, min=1, max=5, reflev=2, missing=., usemiss=1,
                label1='18.5-22.9',
                label2='23-24.9',
                label3='25-29.9',
                label4='30-34.9',
...
data curr.NHS_dementia_long_2023;
set pre_pm; 
run;
